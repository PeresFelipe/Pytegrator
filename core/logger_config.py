...
import logging
import os
import sys  # CORREÇÃO: Importar o módulo 'sys'
from logging.handlers import RotatingFileHandler

# --- Configurações ---
LOG_DIR = "logs"  # Nome da pasta onde os logs serão salvos
LOG_FILENAME = "Pytegrator.log"  # Nome do arquivo de log
...
def setup_logging():
    ...
    # CORREÇÃO: Usar 'sys.excepthook' diretamente, não 'logging.sys.excepthook'
